...
import org.dfxy.service.ISysRoleService;
import org.dfxy.service.ISysUserService;
...
public class SysUserController {
    ...
    public String list(Integer curr, Integer size, SysUser sysUser, Model model) {
        ...
        IPage<SysUser> page = sysUserService.page(new Page<>
                (current,pageSize),queryWrapper);
